...
export default function AdminEssaysPage() {
  ...
  return (
    <AdminLayout title="Essays" subtitle="Manage your intelligence essays">
      {/* Actions Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-10 pr-10 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-azure focus:border-transparent bg-white"
            >
        ...
        <Link
          ...
          className="inline-flex items-center space-x-2 bg-azure text-white px-6 py-2 rounded-lg font-bold hover:bg-azure/90 transition-colors"
        >
          <Plus size={20} />
          <span>New Essay</span>
        </Link>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-12 text-center">
            <p className="text-gray-500 mb-4">No essays found</p>
            <Link
              href="/admin/essays/new"
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredPosts.map((post) => (
                <tr key={post.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="inline-block px-3 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-full uppercase">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end space-x-2 relative">
                      <Link
                        href={`/admin/essays/${post.id}/edit`}
