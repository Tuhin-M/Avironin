    ...
    <AdminLayout title="Blogs" subtitle="Manage your blog posts">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-coral focus:border-transparent w-64"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-10 pr-10 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-coral focus:border-transparent bg-white"
            >
        ...
        <Link
          ...
          className="inline-flex items-center space-x-2 bg-coral text-white px-6 py-2 rounded-lg font-bold hover:bg-coral/90 transition-colors"
        >
          <Plus size={20} />
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredPosts.map((post) => (
                <tr key={post.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="inline-block px-3 py-1 bg-coral/10 text-coral text-xs font-bold rounded-full uppercase">
